...
function Foundations() {
  const colors = ['text', 'text-muted', 'background', 'surface', 'border', 'accent', 'link', 'focus', 'error', 'success'];
  ...
  return <Stack>
    ...
    <section><h2>Typography</h2><h1 style={{ fontSize: 'var(--font-size-2xl)' }}>A warm editorial headline</h1><p style={{ maxWidth: '70ch' }}>Body copy is optimized for long-form reading, useful fallbacks, and comfortable line height without requiring a licensed webfont.</p></section>
